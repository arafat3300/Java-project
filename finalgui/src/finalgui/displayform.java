 ...
 * @author SoFa
 */
public class displayform extends Scene {
    
     public displayform(Parent parent, double d, double d1,Stage primaryStage) throws IOException {
        super(parent, d, d1);
         ...
         StackPane forimage=new StackPane();
                ...
                for(int i=0;i<results.size();i++){
                 ...
                 Maatchno.setFont(Font.font("Aharoni", FontWeight.BOLD, FontPosture.ITALIC, 15));
                   ...
                   //Label price=new Label("silver tickets price "+results.get(i).getSilverprice()+"  gold tickets price "+results.get(i).getGoldprice()+"  platinum tickets price "+results.get(i).getPlatprice() );
                       Text space=new Text("------------------------------------------------------------------------");
